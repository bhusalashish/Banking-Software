/*Q Project on Banking System using Excel File
Name:- Ashish Bhusal & Deepak Joshi
Roll no:- 2012518(28)  /   2012536(34)
Section:- A
*/
#include<bits/stdc++.h>
#include<windows.h>
...
class account
{
	...
	void setaccount()
		...
		int check()
		{
			...
			cout<<"**********************************"<<endl;
    		SetCursor(45,7);
			cout<<"WELCOME TO GLOCAL BANK"<<endl;
    		SetCursor(40,9);
			cout<<"**********************************"<<endl<<endl<<endl;
			SetCursor(45,11);
			cout<<"Enter Password to Continue:";
...
int main()
{
    ...
    do{
		...
		cout<<"Time:- "<<current_time->tm_hour<<":"<<current_time->tm_min<<":"<<current_time->tm_sec<<" ";
		Sleep(1000);
    	SetCursor(40,2);
    	cout<<"Enter Your choice:";
    	SetCursor(40,4);
